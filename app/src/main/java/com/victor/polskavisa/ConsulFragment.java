...
public class ConsulFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.consul_layout, null);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        scrollContainer = (ScrollView) getActivity().findViewById(R.id.consul_scroll);
        ...
        title = (TextView) getActivity().findViewById(R.id.consul_title_view);
        content = (TextView) getActivity().findViewById(R.id.consul_content_view);
        ...
        content.setText(Html.fromHtml(getString(R.string.consul_content)));
    }
