...
public class ImpInfoFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.imp_info_layout, null);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        scrollContainer = (ScrollView) getActivity().findViewById(R.id.important_scroll);
        ...
        title = (TextView) getActivity().findViewById(R.id.important_title_view);
        content = (TextView) getActivity().findViewById(R.id.important_content_view);
        ...
        content.setText(Html.fromHtml(getString(R.string.important_content)));
    }
