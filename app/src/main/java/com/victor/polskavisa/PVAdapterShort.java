...
public class PVAdapterShort extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class PVViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public PVViewHolder(View itemView, int i) {
            ...
            if (i == NOT_HEADING_ITEM) {
                itemImage = (ImageView) itemView.findViewById(R.id.three_p_list_image);
                itemTitle = (TextView) itemView.findViewById(R.id.three_p_list_item_title);
                actImage = (ImageView) itemView.findViewById(R.id.three_p_list_act_image);
    ...
    public PVAdapterShort(List<ListItemInterface> dataList, List<Typeface> fontList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        int layoutId = i == NOT_HEADING_ITEM ? R.layout.three_possition_row_layout : R.layout.title_layout;
